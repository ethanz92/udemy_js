...
// console.log(odds);
let averageOdds = 0;
for (const x of odds) averageOdds += x;
...
console.log(oddsAll);
for (const [team, odds] of oddsAll) {
...
//jonas ver: ATTN
const {odds: {team1: team1b, x: drawb, team2: team2b},} = game;
console.log(team1b, drawb, team2b);
